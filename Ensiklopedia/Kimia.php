      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav text-uppercase ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#Kimia">Kimia</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="Biologi.php">Biologi</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
           ...
           <?php  
            ...
            $sql = "SELECT * FROM artikel WHERE kategori ='Kimia' order by id_artikel  desc LIMIT $offset, $no_of_records_per_page ";
            ...
            while($row = mysqli_fetch_array($res_data)){
                ...
                $img_artikel="../admin/pages/images/".$row[3];
                $tanggal = $row[4];
                $kategori=$row[5];
          ?>
          <div class="card mb-4">
